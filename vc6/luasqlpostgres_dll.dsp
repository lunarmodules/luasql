...
# ADD CPP /nologo /MD /W3 /GX /O2 /I "../../lua/include" /I "../postgresql/src/include" /I "../postgresql/src/interfaces/libpq" /I "../../compat" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "luasqlpostgres_dll_EXPORTS" /YX /FD /c
...
# ADD LINK32 lua50.lib lualib50.lib libpq.lib wsock32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /nologo /dll /machine:I386 /out:"../bin/vc6/postgres.dll" /libpath:"../../lua/lib/vc6" /libpath:"../postgresql/src/interfaces/libpq/Release"
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "../../lua/include" /I "../postgresql/src/include" /I "../postgresql/src/interfaces/libpq" /I "../../compat" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "luasqlpostgres_dll_EXPORTS" /YX /FD /GZ /c
