...
# ADD CPP /nologo /MD /W3 /GX /O2 /I "../../lua/include" /I "../oci8/oci/include" /I "../../compat" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "luasqloci8_dll_EXPORTS" /FR /YX /FD /c
...
# ADD LINK32 lua50.lib lualib50.lib oci.lib wsock32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /nologo /dll /machine:I386 /out:"../bin/vc6/oci8.dll" /libpath:"../../lua/lib/vc6" /libpath:"../oci8/oci/lib/msvc"
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "../../lua/include" /I "../oci8/oci/include" /I "../../compat" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "luasqloci8_dll_EXPORTS" /YX /FD /GZ /c
...
# ADD LINK32 lua50d.lib lualib50d.lib oci.lib wsock32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /nologo /dll /debug /machine:I386 /out:"../bin/vc6/oci8d.dll" /pdbtype:sept /libpath:"../../lua/lib/vc6" /libpath:"../oci8/oci/lib/msvc"
