...
SOURCE="$(InputPath)"
PostBuild_Cmds=cd ../bin/vc6	zip.exe luasql-2.0-mysql41-win32.zip luasql/mysql41.dll	zip.exe -j luasql-2.0-mysql41-win32.zip ../../../external-src/mysql-4.1.12-win32/bin/libmySQL.dll
