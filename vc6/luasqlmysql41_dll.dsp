...
# ADD CPP /nologo /MT /W3 /GX /O2 /I "../../lua/include" /I "../mysql-4.1.8-win/include" /I "../../compat" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "luasqlmysql41_dll_EXPORTS" /FR /YX /FD /c
...
# ADD CPP /nologo /MTd /W3 /Gm /GX /ZI /Od /I "../../lua/include" /I "../mysql-4.1.8-win/include" /I "../../compat" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "luasqlmysql41_dll_EXPORTS" /YX /FD /GZ /c
...
# ADD LINK32 lua50d.lib lualib50d.lib libmysql.lib wsock32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib /nologo /dll /debug /machine:I386 /out:"../bin/vc6/mysqld.dll" /pdbtype:sept /libpath:"../../lua/lib/vc6" /libpath:"../mysql-4.1.8-win/lib/debug"
